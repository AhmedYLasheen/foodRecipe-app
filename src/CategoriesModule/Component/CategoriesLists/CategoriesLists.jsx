...
import NoDataImage from "../../../assets/images/nullItem1.png";
import Modal from "react-bootstrap/Modal";
import { useForm } from "react-hook-form";
import { toast } from "react-toastify";
import DeleteComponent from "../../../SharedModule/Components/DeleteModal/DeleteModal";
  ...
  const DeleteItem = async (deleteItemId) => {
    try {
      const response = await axios.delete(
        `https://upskilling-egypt.com:3006/api/v1/Category/${deleteItemId}
        `,
